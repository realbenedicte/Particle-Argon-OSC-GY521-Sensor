...
#include "Particle.h"
#line 1 "/Users/maximegordon/Desktop/ParticleMG/rope-accl-stretch/src/rope-accl-stretch.ino"
//Rope - Accelerometer and Stretch code
//AddressName: rope
//PortNumber: 3344 
//uses GY521 sensor + conductive thread 
...
void setup();
void loop();
#line 12 "/Users/maximegordon/Desktop/ParticleMG/rope-accl-stretch/src/rope-accl-stretch.ino"
...
unsigned int outPort = 3344; //computer port -- use this in Max 
...
void loop() {
    ...
    int stretchValue = analogRead(A0); //pin A0 of argon
